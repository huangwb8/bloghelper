...
var GithubLink  =   "https://github.com/huangwb8";
var PayPalLink  =   "https://github.com/huangwb8";
$('#paypal-donate>a').href = PayPalLink;
$('#github-box>a').href = GithubLink;
var qrcodes = {
    'btc_donate'	:	'./images/pay.jpg',	// 二维码路径
    'alipay_donate'	:	'../simple/images/pay_aliyun.png',	// 支付宝二维码
    'alipay_donate_link'   :   'https://qr.alipay.com/fkx16791tou8uwk7ejjp661',   // 支付宝二维码上的链接，必须换成自己的连接！！！手机点击会自动跳转到支付宝。
